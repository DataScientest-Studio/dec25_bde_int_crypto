...
loaded_model = joblib.load("src/service/predict/svm/svm_model.pkl")

scaler = joblib.load("src/service/predict/svm/svm_scaler.pkl")
...
df = pd.read_csv("src/service/predict/svm/data.csv")
